...
const SurveyCompletedPage = () => {
    ...
    const completed = DEMO_CLAIMS.filter((c) => c.status === 'Completed');

    return (
        <div className="min-h-screen flex flex-col">
            <AppHeader />
            <PageTitleBar title="Survey Completed" subtitle={`${completed.length} surveys finished`} />
                ...
                <div className="login-card" style={{ background: '#FFFFFF' }}>
                    <div className="px-2 pt-3 pb-2 flex items-center justify-between">
                        ...
                        <span
                            ...
                            style={{ background: COLORS.statusCompleted }}
                        >
                            {completed.length}
                        </span>
                    </div>
