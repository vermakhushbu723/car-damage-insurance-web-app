...
const NAV_ITEMS = [
    ...
    { id: 'ai-ila', label: 'AI Damage Assessment', path: ROUTES.INTIMATION.AI_ILA, Icon: CpuIcon },
    { id: 'annotation-studio', label: 'Offline Training', path: ROUTES.INTIMATION.ANNOTATION_STUDIO, Icon: PenBoxIcon },
