...
const PORTAL_ROLE = 'preinspection_agent';
...
// Every route except LOGIN itself requires a valid preinspection_agent
// session -- hitting any of these URLs directly without logging in first
// bounces back to ROUTES.LOGIN (see RequireAuth). Spread into AppRoutes.
