...
import PreinspectionListCard from '../components/PreinspectionListCard';
...
const DashboardPage = () => {
    ...
    const listConfig = {
        [VIEW.TOTAL]: { title: 'All Preinspections', badgeBg: COLORS.primary },
        [VIEW.COMPLETED]: { title: 'Completed', badgeBg: COLORS.statusCompleted },
        [VIEW.PENDING]: { title: 'Pending', badgeBg: COLORS.statusPending },
        [VIEW.SEARCH]: { title: query ? `${filteredClaims.length} result${filteredClaims.length !== 1 ? 's' : ''} found` : 'All Preinspections', badgeBg: COLORS.iconClaim },
    }[view];
                ...
                <div className="login-card" style={{ background: '#FFFFFF' }}>
                        ...
                        <div className="pb-2">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    placeholder="Search PI ref. number, reg. no., name…"
                    ...
                    <div className="flex-1 pb-6">
                        {filteredClaims.length === 0 ? (
                            ...
                            >
                                <p className="text-sm font-medium">No preinspections match your search.</p>
                            </div>
                        ) : (
                            filteredClaims.map((claim) => (
                                <PreinspectionListCard
                                    key={claim.id}
                                    claim={claim}
