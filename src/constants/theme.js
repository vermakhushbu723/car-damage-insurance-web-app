// =============================================
// GLOBAL COLOR THEME CONSTANTS
// =============================================

export const COLORS = {
    // Primary brand colors
    primary: '#3B82F6',       // Blue - main brand color
    primaryDark: '#DAF0FE',   // Darker blue
    ...
    // Status / Badge colors
    statusPending: '#EF4444',   // Red - Pending status
    ...
    textBlue: '#3B82F6',       // Blue text
    textOrange: '#E07B39',     // Orange text
    textGreen: '#22C55E',      // Green text
    textRed: '#EF4444',        // Red text
    ...
    iconDL: '#EF4444',         // Red icon
    iconRC: '#16A34A',         // Green icon
    iconRepair: '#EA580C',     // Orange icon
    iconKYC: '#0EA5E9',        // Sky blue icon
    iconPhone: '#0EA5E9',      // Sky blue phone icon
